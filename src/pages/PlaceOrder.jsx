                ...
                <div className='mt-12'> 
                    ...
                    <div className='flex flex-col'>
                        <div onClick={() => setMethod('stripe')} className='flex items-center gap-3 border p-2 cursor-pointer'>
                            ...
                            <img className='h-5 mx-4' src={assets.stripe_logo} alt='googlePay'/>
                        </div>
                    ...
                    <div className='w-full text-end mt-8'>
                        <button onClick={()=>navigate('/orders')} className='bg-black text-white py-3 px-16 rounded'>PLACE ORDER</button>
                    </div>
                </div>
            </div> 
        </div>
